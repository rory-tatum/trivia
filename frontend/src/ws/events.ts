...
export const HOST_END_ROUND = "host_end_round" as const;
export const HOST_BEGIN_SCORING = "host_begin_scoring" as const;
...
export const TEAM_JOINED = "team_joined" as const;
export const QUIZ_LOADED = "quiz_loaded" as const;
...
export const SUBMISSION_RECEIVED = "submission_received" as const;
export const SCORING_OPENED = "scoring_opened" as const;
export const SCORING_DATA = "scoring_data" as const;
...
export const ROUND_SCORES_PUBLISHED = "round_scores_published" as const;
